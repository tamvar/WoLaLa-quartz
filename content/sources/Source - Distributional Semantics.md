---
title: Source - Distributional Semantics
type: source
status: active
updated: 2026-04-26
tags:
...
For the present debate, the conclusion chapter is especially important. Lenci and Sahlgren directly engage recent criticisms such as Bender and Koller’s question of whether language models are "climbing the right hill." They argue that critiques often rest on a too-dualistic picture of meaning and on what they call, following Sahlgren and Carlsson, a `singleton fallacy` about meaning and understanding.
...
## Open Questions
- Which parts of the distributional-semantics research program remain viable in transformer-era models, and which need deeper revision?
- Does the book's multimodal and inferential expansion preserve a single distributional program, or point toward a broader hybrid semantic architecture?
