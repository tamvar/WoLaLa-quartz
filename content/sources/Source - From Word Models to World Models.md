...
## Key Points
- the paper frames linguistic meaning as a context-sensitive mapping from natural language into a probabilistic language of thought.
- its architecture combines large language models for broad-coverage translation with probabilistic programs for inference and world modeling.
- the paper presents examples across probabilistic, logical, relational, visual, physical, and social reasoning.
- it treats language and thought as deeply related but distinct, and positions the system as an interface between linguistic input and structured cognition.
- the paper argues that language can help construct and update world models, not just label already-fixed symbolic states.
